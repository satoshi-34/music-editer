...
/**
 * 目的別ガイド（タスク起点）。ユーザーインタビュー（#89）の「書きたいことをどうやるか」を
...
export const TASK_GUIDES: TaskGuide[] = [
  ...
  },
  {
    ...
    keywords: ['フォント', '書体', 'タイトル', '明朝', 'ゴシック', '文字サイズ', '太さ', '改行'],
    steps: [
      '楽譜のタイトル（サブタイトル・作者欄でも同じ）をクリックして編集ダイアログを開く',
      '「書体・サイズ・太さ」で選ぶ（タイトル・サブタイトル・作者欄にまとめて効く。音符の書体は変わらない）',
      '文字そのものも同じダイアログで直せる（Enter で改行でき、2行以上のタイトルにできる）',
      '「決定」で確定、「キャンセル」または Esc で開く前へ戻る',
    ],
  },
  {
    id: 'print',
