...
export const TASK_GUIDES: TaskGuide[] = [
  {
    ...
    steps: [
      '「演奏記号」タブでタイ／スラーツールを選ぶ',
      '始点の音符 → 終点の音符の順にクリックする（小節をまたいでもよい）',
      '弧をクリックして選び、ドラッグで形を調整、Delete で削除できる',
    ],
    seeAlso: 'タイ／スラー',
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      '変えたい小節をクリックすると入力欄が開く。空欄で確定すると指定を外せる',
    ],
  ...
  },
  {
    ...
    steps: ['「演奏記号」タブで装飾音符ツールを選び、付けたい音符をクリックする'],
  },
  {
    id: 'lyrics',
    title: '歌詞やコード記号を付けたい',
  ...
  },
  {
    ...
    steps: [
      ...
      'それでも鳴らないときは「再生・音色」タブの音量と、OS側の消音を確認する',
    ],
