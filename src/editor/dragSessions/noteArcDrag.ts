...
/** 符頭のタイ／松葉ドラッグが読む文脈（svg 側と共有する TiePreviewContext に、編集不可フラグを足したもの） */
export interface NoteArcDragContext extends TiePreviewContext {
  disabled: boolean | undefined;
}

/** 符頭の当たり判定 1 つに、タイ／松葉ドラッグの開始（mousedown）と確定（mouseup）を付ける */
export function attachNoteArcDragListeners(
  hit: SVGElement,
  ctx: NoteArcDragContext,
